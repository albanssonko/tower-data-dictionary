...
### `std.paylocity_ev_employees_detail`  (rows: 8,271 | cols: 136)
...
### `std.paylocity_ev_paystatements_detail`  (rows: 966,446 | cols: 13 | PK: id)
...
### `std.paylocity_av_shift_unified`  (rows: 1,039 | cols: 22)
...
### `std.paylocity_ev_shift_unified`  (rows: 341,922 | cols: 25 | PK: shiftId, employeeId)
...
### `std.paylocity_ev_punches`  (rows: 1,078,509 | cols: 42)
...
### `ref.paylocity_ev_employees_basic`  (rows: 8,285 | cols: 7 | PK: id)
