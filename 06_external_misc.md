...
### `ref.freshsales_contacts`  (rows: 235,336 | cols: 228)
...
### `ref.driver_emails`  (rows: 23,846 | cols: 28)
...
### `ref.weather`  (rows: 98,968 | cols: 78)
...
### `ref.weather_codes`  (rows: 69 | cols: 2)
...
### `ref.FuelAndEnergyWAV`  (rows: 95,877 | cols: 15)
...
### `std.charging_sessions`  (rows: 140,676 | cols: 34)
