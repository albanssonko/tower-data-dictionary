...
### `ref.freshsales_contacts`  (rows: 239,411 | cols: 228)
...
### `ref.driver_emails`  (rows: 25,232 | cols: 29 | PK: id)
...
### `ref.weather`  (rows: 103,850 | cols: 78 | PK: id)
...
### `ref.FuelAndEnergyWAV`  (rows: 97,110 | cols: 15)
...
### `std.charging_sessions`  (rows: 155,252 | cols: 34)
