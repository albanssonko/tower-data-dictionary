...
### `ref.freshsales_contacts`  (rows: 237,145 | cols: 228)
...
### `ref.driver_emails`  (rows: 24,821 | cols: 29 | PK: id)
...
### `ref.weather`  (rows: 100,922 | cols: 78 | PK: id)
...
### `ref.FuelAndEnergyWAV`  (rows: 96,588 | cols: 15)
...
### `std.charging_sessions`  (rows: 144,545 | cols: 34)
