...
### `ref.driver_emails`  (rows: 24,540 | cols: 28 | PK: id)
...
### `ref.weather`  (rows: 100,190 | cols: 78 | PK: id)
...
### `ref.FuelAndEnergyWAV`  (rows: 96,333 | cols: 15)
...
### `std.charging_sessions`  (rows: 143,290 | cols: 34)
