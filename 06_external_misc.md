...
### `ref.freshsales_contacts`  (rows: 237,962 | cols: 228)
...
### `ref.driver_emails`  (rows: 25,049 | cols: 29 | PK: id)
...
### `ref.weather`  (rows: 101,898 | cols: 78 | PK: id)
...
### `ref.FuelAndEnergyWAV`  (rows: 96,947 | cols: 15)
...
### `std.charging_sessions`  (rows: 146,875 | cols: 34)
