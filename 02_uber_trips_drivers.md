...
### `std.uber_ev_trip_activity`  (rows: 7,217,926 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 438,960 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 512,440 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 42,919 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 521,594 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 31,487 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 642,404 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 179 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,409,164 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 106,050 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 184,561 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 3,191 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 4,018,046 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,225 | cols: 13)
...
### `ref.uber_vehicles`  (rows: 687 | cols: 15 | PK: _id)
...
### `ref.uber_shift_logs`  (rows: 1,450,252 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 18,970 | cols: 16)
