...
### `std.uber_ev_trip_activity`  (rows: 7,162,930 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 433,610 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 507,541 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 41,934 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 516,594 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 30,498 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 637,387 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 218 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,354,541 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 99,660 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 179,000 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 2,459 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 3,715,747 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 63,981 | cols: 11)
...
### `ref.uber_shift_logs`  (rows: 1,387,694 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 10,214 | cols: 16)
