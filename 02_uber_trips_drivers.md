...
### `std.uber_ev_trip_activity`  (rows: 7,183,119 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 435,160 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 509,507 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 42,200 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 518,247 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 30,763 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 639,164 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 141 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,373,374 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 101,660 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 180,982 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 2,613 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 3,827,391 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,016 | cols: 11)
...
### `ref.uber_shift_logs`  (rows: 1,409,369 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 12,578 | cols: 16)
