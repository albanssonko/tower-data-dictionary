...
### `std.uber_ev_trip_activity`  (rows: 7,202,794 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 437,188 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 511,123 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 42,601 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 520,167 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 31,168 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 640,978 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 208 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,393,352 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 104,093 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 183,358 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 2,931 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 3,937,161 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,140 | cols: 11)
...
### `ref.uber_shift_logs`  (rows: 1,432,841 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 16,672 | cols: 16)
