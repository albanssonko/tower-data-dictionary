...
### `std.uber_ev_trip_activity`  (rows: 7,295,839 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 446,249 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 519,271 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 44,280 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 528,353 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 32,847 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 649,110 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 131 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,484,274 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 113,977 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 192,325 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 4,367 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 4,443,723 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,368 | cols: 13)
...
### `ref.uber_vehicles`  (rows: 695 | cols: 15 | PK: _id)
...
### `ref.uber_shift_logs`  (rows: 1,535,459 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 28,999 | cols: 16)
