...
### `std.uber_ev_trip_activity`  (rows: 7,171,613 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 434,366 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 508,142 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 42,056 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 517,318 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 30,619 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 638,163 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 222 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_transactions`  (rows: 1,362,337 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 100,383 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 179,671 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 2,532 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 3,762,553 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,015 | cols: 11)
...
### `ref.uber_shift_logs`  (rows: 1,396,926 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 11,221 | cols: 16)
