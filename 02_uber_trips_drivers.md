...
### `std.uber_ev_trip_activity`  (rows: 7,210,236 | cols: 21 | PK: trip_uuid)
...
### `std.uber_wav_trip_activity`  (rows: 438,084 | cols: 22 | PK: trip_uuid)
...
### `std.uber_ev_driver_activity`  (rows: 511,659 | cols: 8 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_activity`  (rows: 42,763 | cols: 9 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_quality`  (rows: 520,860 | cols: 13 | PK: driver_uuid, start_time)
...
### `std.uber_wav_driver_quality`  (rows: 31,322 | cols: 14 | PK: driver_uuid, start_time)
...
### `std.uber_ev_driver_payments`  (rows: 641,685 | cols: 16 | PK: DriverUUID, StartTime)
...
### `std.uber_wav_driver_payments`  (rows: 27,853 | cols: 17 | PK: DriverUUID, StartTime)
...
### `std.uber_ev_driver_locations`  (rows: 176 | cols: 11 | PK: DriverUuid, LocationEpochMs)
...
### `std.uber_ev_driver_performance`  (rows: 204,544 | cols: 18 | PK: _id)
...
### `std.uber_ev_driver_transactions`  (rows: 1,400,924 | cols: 12)
...
### `std.uber_wav_driver_transactions`  (rows: 104,806 | cols: 12)
...
### `std.uber_ev_auto_pos`  (rows: 183,684 | cols: 19 | PK: _id)
...
### `std.uber_wav_auto_pos`  (rows: 3,017 | cols: 20 | PK: _id)
...
### `std.uber_ev_timeline`  (rows: 3,975,810 | cols: 10 | PK: DriverUuid, Event, EventEpochMs)
...
### `ref.uber_drivers`  (rows: 64,190 | cols: 11)
...
### `ref.uber_vehicles`  (rows: 686 | cols: 15 | PK: _id)
...
### `ref.uber_shift_logs`  (rows: 1,441,271 | cols: 16)
...
### `ref.uber_shift_logs_wav`  (rows: 17,874 | cols: 16)
