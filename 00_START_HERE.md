...
| [`07_powerbi_glossary.md`](07_powerbi_glossary.md) | The Power BI semantic layer built on top of this SQL schema — DAX measure definitions, the driver A/B/C/D grading system (AR/CR/EPH/UR), turnover/safety/fleet-status terminology, confirmed DAX bugs/hardcoded constants, and (in its appendix) a full Power BI table → SQL source mapping for all 87 tables. Two merged passes as of 2026-09-02 — see its "Genuinely still open" section for what's not yet covered. |
